    ...
    <div class="controls col-md-6 col-lg-6 mx-auto">
            ...
            <div class="col-md-12">
                <div class="form-group cont-text">
                    ...
                    <input id="form_name" required type="text" name="fname" class="form-control" placeholder="Please enter your firstname*"   data-error="Firstname is required.">
            ...
            <div class="col-md-12">
                <div class="form-group cont-email">
                    ...
                    <input id="form_email" type="email" required  name="email" class="form-control" placeholder="Please enter your email *" required="required" data-error="Valid email is required.">
                    <div class="help-block with-errors"></div>
                </div>
            </div>
            ...
            <div class="col-md-12">
                <div class="form-group cont-mesg">
                    ...
                    <textarea id="form_message" name="message" required class="form-control" placeholder="Enter your Message *" rows="4" required="required" data-error="Please, leave us a message."></textarea>
                    <div class="help-block with-errors"></div>
                </div>
            </div>
            <div class="col-md-12">
