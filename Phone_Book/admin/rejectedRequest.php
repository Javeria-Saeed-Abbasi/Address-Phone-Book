...
<head>
    ...
    <title>Rejected Request Page</title>
<style>
...
?>
        ...
        <div class="col-8 col-md-10 col-lg-10 pt-2 bg-light overflow-auto" style="max-height:460px;">
                    ...
                    <h1 class="text-center">Rejected User Requests</h1>
                    </div>
                    <!-- Search bar -->
              ...
              <!-- //jumbotorn ends div -->
                    ...
                    <table class="table table-striped table-responsive-sm w-auto" id="rejected">
                    ...
                    <?php
                        ...
                        <td><button class="btn btn-danger my-2"><?php echo $rows['status']?></button></td>                        
                        <td align="center">
